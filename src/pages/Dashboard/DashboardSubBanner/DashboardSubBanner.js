    ...
    <div className="py-5 shadow-lg my-16 px-5 md:px-20 bg-gray-200">
      <div>
        <div className="grid grid-cols-2 md:grid-cols-4 justify-center mx-auto w-full text-center">
          ...
          <div className="shadow-xl mx-auto w-48 bg-primary rounded-2xl p-2">
            <p className="text-center text-xl text-white pb-2 font-semibold">
              Brand Image
            </p>
            <img
          ...
          <div className="shadow-xl mx-auto w-48 bg-[#ED6A49] rounded-2xl p-2">
            <p className="text-center text-xl text-white pb-2 font-semibold">
              Food panda
            </p>
            <img
          ...
          <div className="shadow-xl mx-auto w-48 bg-[#000] rounded-2xl p-2">
            <p className="text-center text-xl text-white pb-2 font-semibold">
              Pathao sell
            </p>
            <img
