...
export default class HomepageLInk extends Component {
  ...
  render() {
    ...
    return (
      <div className="pb-10">
        <div className="px-5 md:px-20 bg-gray-100 py-5 rounded-xl">
          <Slider ref={(c) => (this.slider = c)} {...settings}>
            <div key={1} className="mx-2 md:mx-10 pr-5 pb-2 ">
              <div>
                <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 py-5 rounded-lg ">
                  <img className="w-12 mx-auto" src={daraz} alt="" />
                  <p className="mt-5 text-center">Daraz</p>
                </div>
              </div>
            </div>
            <div key={2} className="mx-2 md:mx-10 pr-5 pb-2">
              <div>
                <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 py-6 rounded-lg">
                  <img className="w-16 mx-auto" src={bkash} alt="" />
                  <p className="mt-5  text-center">bKash</p>
                </div>
              </div>
            </div>
            <div key={3} className="mx-2 md:mx-10 pr-5 mr-5 pb-2">
              <div>
                <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 py-4  rounded-lg">
                  <img className="w-16" src={citybank} alt="" />
                  <p className="mt-5 text-center">City Bank</p>
                </div>
              </div>
            </div>
            <div key={4} className="mx-2 md:mx-10 pr-5 mr-5 pb-2">
              <div>
                <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 py-7  rounded-lg">
                  <img className="w-28" src={nagad} alt="" />
                  <p className="mt-4 text-center">Nagad</p>
                </div>
              </div>
            </div>
            <div key={5} className="mx-2 md:mx-10 pr-5 mr-5 pb-2">
              <div>
                <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 py-3 rounded-lg">
                  <img className="w-28 mx-auto" src={walton} alt="" />
                  <p className="mt-3 text-center">Walton</p>
                </div>
              </div>
            </div>
            <div key={6} className="mx-2 md:mx-10 pr-5 mr-5 pb-2">
              <div className="shadow-2xl bg-base-100 w-40 h-36 px-10 rounded-lg">
                <img className="w-24 mx-auto" src={samsung} alt="" />
